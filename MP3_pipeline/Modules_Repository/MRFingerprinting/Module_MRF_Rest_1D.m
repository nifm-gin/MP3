function [files_in,files_out,opt] = Module_MRF_Rest_1D(files_in,files_out,opt)
...
if isempty(opt)
    ...
    user_parameter(:,17)   = {'Select the scans to use for restriction','1Scan','','',{'SequenceName'}, '',''};
    user_parameter(:,18)   = {'Indicate the type of restriction','cell', {'T2', 'DH2O'}, 'RestType', '', '',...
        { 'Choose:'
        '	- ''ClassicMRF'' to use the Dan Ma method'
        '	- ''RegressionMRF'' to use the regression method'
        }'};
