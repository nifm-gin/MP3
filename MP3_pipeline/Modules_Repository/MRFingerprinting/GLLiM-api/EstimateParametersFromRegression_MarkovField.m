function [Yestim, Parameters, Cov, Kurt, Pik] = EstimateParametersFromRegression_MarkovField(Xtest, Xtrain, Ytrain, Ytest, Parameters, MF)
...
if isempty(Xtest)
    ...
    [Yestim, Cov, Kurt, Pik] = EstimateParametersFromModel_MarkovField(Xtest, Parameters.theta, MF, 0);
end
