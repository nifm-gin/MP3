function X=HadamardFitFunction(xfix,xvar)
...
Effective_PLD = xfix.Effective_PLD; %s Effective_PLD corrected for the interslice time;
...
%figure(200), plot(Effective_PLD,X);
